...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        die("حساب المشرف غير موجود في النظام!");
    }
    $stmt_fetch->close();
} else {
...
<head>
    <meta charset="UTF-8">
    <title>لوحة التحكم | تعديل بيانات المدير</title>
    <style>
        ...
        .sidebar a:hover, .sidebar a.active { background-color: #495047; color: #fff; }
...
<div class="main-content">
    <div class="form-container">
        <h2>تعديل بيانات المشرف الحالي</h2>
        ...
        <form action="update_admin.php?id=<?php echo $admin_id; ?>" method="POST">
            <div class="form-control">
                <label for="name">الاسم الكامل للمشرف:</label>
            ...
            <button type="submit" name="update_admin" class="btn-submit">تحديث البيانات وحفظها</button>
